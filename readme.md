[![GitHub downloads](https://img.shields.io/github/downloads/amature0000/SOTA/total.svg?logo=github)](https://github.com/amature0000/SOTA/releases)

![img](assets/Animation3.webp)

SOTA(Simple OCR-Translate for Anything)는 OCR을 이용해 화면의 텍스트를 추출 후 번역하는 간단한 프로그램입니다.

이 프로젝트는 [MORT](https://github.com/killkimno/MORT) 프로젝트로부터 영감을 받아 만들어졌습니다.

# SOTA - Simple OCR Translate for Anything
SOTA는 OCR을 이용해 화면 상의 텍스트를 캡처한 후, 사용자 설정에 따라 맞춤형 번역 서비스를 제공하는 프로그램입니다.
...
SOTA 프로젝트는 이러한 문제점을 해결하기 위해 개발되었습니다.
